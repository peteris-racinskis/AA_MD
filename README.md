...
Working with color creates a number of new problems so everything in this repository works on grayscale versions of the input image unless otherwise specified.
