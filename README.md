...
Working with color creates a number of new problems so everything in this repository works on grayscale versions of the input image, because working with color turns out to be a massive pain in debugging terms - just as expected.
